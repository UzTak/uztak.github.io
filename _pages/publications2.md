...
8. <b>Takubo, Y.</b><sup>&ast</sup>, Guffanti, T.<sup>&ast</sup>, Gammelli, D.<sup>&ast</sup>, Pavone, M., and D'Amico, S., "Towards Robust Spacecraft Trajectory Optimization via Transformers," IEEE Aerospace Conference 2025 (submitted). (*Equal Contribution)
